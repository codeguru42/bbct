        ...
        deleteButton.addActionListener(evt -> {
            try {
                ...
                try {
                    ...
                    // update the view
                    if (numCards == 0) {
                        Container parent1 = EditCardsPanel.this.getParent();
                        CardLayout layout = (CardLayout) parent1.getLayout();

                        parent1.remove(EditCardsPanel.this);
                        layout.show(parent1, BBCTFrame.FIND_CARDS_MENU_CARD_NAME);
