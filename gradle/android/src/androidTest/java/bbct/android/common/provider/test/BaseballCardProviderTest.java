...
public class BaseballCardProviderTest extends
    ...
    static {
        CARDS.add(new BaseballCard("Baseball", false, "Excellent", "Topps", 1991, 278,
                10000, 1, "Alex Fernandez", "White Sox", "Pitcher"));
        CARDS.add(new BaseballCard("Baseball", false, "Excellent", "Topps", 1974, 175,
                10000, 1, "Bob Stanley", "Red Sox", "Pitcher"));
        CARDS.add(new BaseballCard("Baseball", false, "Excellent", "Topps", 1985, 201,
                10000, 1, "Vince Coleman", "Cardinals", "Left Field"));
        CARDS.add(new BaseballCard("Baseball", false, "Excellent", "TMG", 1993, 5, 10000,
                1, "Ken Griffey Jr.", "All-Star", "Center Field"));
        CARDS.add(new BaseballCard("Baseball", false, "Excellent", "Upper Deck", 1993, 18,
                10000, 1, "Dave Hollins", "Phillies", "Third Base"));
        CARDS.add(new BaseballCard("Baseball", false, "Excellent", "Upper Deck", 1990, 189,
                10000, 1, "Tom Browning", "Reds", "Pitcher"));
        CARDS.add(new BaseballCard("Baseball", false, "Excellent", "Topps", 1982, 121,
    ...
    public void testInsert() {
        BaseballCard newCard = new BaseballCard("Baseball", true, "Mint", "Code Guru Apps",
