...
public class PremiumActivity extends MainActivity
    ...
    public void onChangeCardClosed(BaseballCard card) {
        //currentDetailsFrag.ReloadDetailsWithChangedPicture(imagePath);
        BaseballCardDetails details = BaseballCardDetails.getInstance(-1, card);
        getSupportFragmentManager()
                .beginTransaction()
    ...
    private BaseballCardDetails currentDetailsFrag = null;
